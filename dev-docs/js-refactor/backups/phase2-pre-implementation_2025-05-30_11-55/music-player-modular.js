/* ==========================================
   MUSIC PLAYER CLASS - MODULAR VERSION
   ========================================== */
...
class MusicPlayer {
    ...
    constructor() {
        ...
        // Initialize modules (Phase 1: Dual-path approach)
        this.audioEngine = new AudioEngine(this.audio);
        this.utils = Utils;
    ...
    setupEventListeners() {
        ...
        this.audio.addEventListener('loadedmetadata', () => {
            // DUAL-PATH: Use module utility for time formatting
    ...
    /* ========================================
       ...
       ======================================== */
      formatTime(seconds) {
        // PHASE 1: Dual-path approach - use module utility but maintain compatibility
        return this.utils.formatTime(seconds);
    }
}

// Make MusicPlayer available globally for main-modular.js
