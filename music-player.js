...
class MusicPlayer {
    constructor() {
        ...
        this.totalTime = document.getElementById('totalTime');        this.playerElement = document.getElementById('musicPlayer');
    ...
    setupEventListeners() {
        ...
        this.audio.addEventListener('timeupdate', () => {
            ...
            this.nextTrack(true); // Pass true to indicate auto-advance
        });
        ...
        const handleMouseMove = (e) => {
            ...
            // Only toggle player if we didn't move and clicked on the music icon overlay (when collapsed)
